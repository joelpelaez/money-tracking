...
class ClassPDO{
	...
	/**
	  ...
	  * @return void
	  */
	public function __construct($drive = 'mysql', $host = 'localhost', $unix_socket = null, $database = 'gestion', $username = 'root', $password = ''){
		$this->_drive    = $drive;
		$this->_host     = $host;
	...
	private function connection(){
		...
		if (isset($this->_unix_socket)) {
			$this->_dsn .= ';unix_socket='.$this->_unix_socket;
		}
		try{
